      ...
      <section className="border-b pb-10">
        ...
        <form className="p-4 gap-10 max-w-3xl">
          ...
          <div>
            <label
              htmlFor="message"
              className="pt-6 block text-sm font-medium text-Black_Color dark:text-White_Color mb-1"
            >
              Message
            </label>
            <textarea
              ...
              className="w-full border-b border-b-Gray_Color rounded-sm px-3 py-2 focus:outline-none resize-none"
              rows={4}
              required
            />
          </div>
